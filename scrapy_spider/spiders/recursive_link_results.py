...
class Search(CrawlSpider):
    ...
    def __init__(self,url_list,search_id):#specified by -a
        ...
        self.start_urls = ['http://www.firstpost.com/bollywood/the-martian-review-matt-damon-brings-disco-and-good-cheer-to-the-red-planet-2452906.html','http://www.allmovie.com/blog/post/the-martian-the-allmovie-review']
